<?php
  ...
  $dictionary = [
    ...
    "aerobic exercise" => "exercise; slow and steady exercise like walking, running, biking, swimming, etc.; exercise that helps your heart stay healthy and work better; exercise that gets your heart pumping; exercise that makes you breathe faster",
    ...
    "allergist" => "doctor who treats allergies, allergy doctor",
    ...
    "amniocentesis" => "test for a baby's health before it is born",
    "amniotic fluid" => "water, fluid surrounding unborn baby in wound",
    ...
    "anerobic" => "needs lack of oxygen, without oxygen",
    ...
    "antiphospholipid antibody test" => "a test to see if you are at risk for blood clots",
    ...
    "asymptomatic infection" => "when you're sick, but you do not feel bad, no symptoms",
    "asymptomatic" => "someone who is sick but does not feel or look sick at the present time now, right now",
    ...
    "benefit" => "help, aid",
    "benign" => "not a danger, not harmful, easily treated, harmless",
    ...
    "cerumen" => "earwax",
    "cervix" => "the lower part of the womb",
    ...
    "chronic" => "constant, never ending, does not go away, long term, long-lasting, lasting a long time",
    ...
    "close proximity" => "near, nearby, close, close to",
    ...
    // "Colin" => "a harmless drudge who designed and coded this application",
    ...
    "community immunity" => "the protection people who aren't vaccinated get when most other people in their community are vaccinated, group protection from a disease",
    ...
    "contagious disease" => "an illness that spreads to others; a disease that you can give to other people; a disease that can make other people sick",
    ...
    "coronary thrombosis" => "heart attack, blood cot in a blood vessel in the heart",
    ...
    "crossbite" => "uper teeth are biting inside the lower teeth",
    ...
    "cystitis" => "infection causing pain when you urinate, bladder infection, pain when you pee",
    ...
    "diabetes" => "disease with too much sugar in the blood; problem with making food into energy; elevated sugar in the blood",
    ...
    "encephalitis" => "swelling of the brain, swollen brain, brain swelling",
    "encephalopathy" => "brain dysfunction",
    "encourage" => "urge",
    "endeavor" => "try, attempt",
    "endocrine" => "related to the hormone producing systems, hormone system",
    ...
    "epidemic" => "disease that most people ge;, widespread sickness",
    ...
    "HPV" => "a virus that can cause cervical cancer and/or oral cancer",
    ...
    "immune" => "when your body can protect itself from a disease; protected from, resistant to",
    ...
    "impaction" => "teeth pressing together; teeth not visible about the gum line",
    "impaired" => "not normal; something is wrong",
    "impede" => "get in the way, slow",
    "imperative" => "important, pressing, urgent",
    "imperceptible" => "hard to see, hidden, cannot be seen",
    ...
    "incidence" => "number of sick people; how many people get sick",
    ...
    "infection" => "illness caused by germs; a sickness you get from germs; disease; illness; sickness; virus; bug; control how to stop sickness",
    ...
    "joint" => "place where two bones come together (knee, elbow, etc.); bone connection",
    "kidney" => "organ that filters blood",
    "lacerate" => "ragged cut, tear",
    "laceration" => "ragged cut, tear",
    "lesion" => "cut, injury, wound, sore",
    "ligament" => "a strong band of tissue that holds your joints together; bone connector; joint tissue",
    ...
    "macular" => "a discolored spot on your skin; a spot on your cornea; eye disease; blindness",
    "magnitude" => "extent, size, how serious",
    "maintain" => "take care of, keep, keep up",
    "mammogram" => "test to check the health of the breast; breast check",
    "malignant" => "cancer",
    ...
    "menopause" => "women’s “change of life”; the change; time in a woman's life when her periods stop; no longer have periods",
    "menstruation" => "period",
    ...
    "mg" => "milligram",
    "microbes" => "very tiny fungi, sometimes viruses, that are too small to see; bacteria, protozoa",
    "might qualify" => "might get",
    "migrate" => "move, travel",
    "migration" => "moving from one place to another; moving; transfer; traveling",
    ...
    "mucus" => "fluid that coats and protects the inside of the nose, mouth, bronchial tubes and other parts of the body; phlegm; nose fluid; mouth fluid; throat coating",
    ...
    "nosocomial" => "an infection you can catch in the hospital",
    "notification" => "notice",
    ...
    "occupation" => "job, work",
    "occupational therapist" => "someone who helps people who are sick or injured learn or relearn everyday activities",
    ...
    "opportunistic infection" => "infection you get because you are already weak",
    "optic neuritis" => "eye disease, disease of the eyes",
    "optimal" => "best, best way",
    "option" => "choice, way",
    "oral" => "mouth and jaw",
    ...
    "orthopedic surgeon" => "bones and joint doctor",
    "orthopedics" => "bone and joint doctor’s office",
    "orthotic" => "support or brace",
    "ossification" => "bone formation, hard, stiff",
    "osteonecrosis" => "bone death",
    "osteoporosis" => "brittle bones",
    "otitis media" => "middle ear infection",
    "outbreak" => "when a large number of people suddenly get sick; sudden increase in number of sicknesses; beginning; start; onset",
    ...
    "passive immunity" => "temporary disease protection from either mother or vaccine",
    ...
    "perinatal death" => "death before birth, stillborn",
    "perinatologist" => "high-risk pregnancy doctore; doctor for pregnancy at risk",
    ...
    "podiatry" => "the medical department that treats problems with feet, medical specialty – feet, foot doctor; treating feet problems",
    ...
    "post-partum depression" => "baby blues; overwhelmed, depressed, unexplained sadness after having a baby",
    ...
    "prescription" => "doctor's orders, medicine, drug order",
    ...
    "prevalence" => "spread, disease spread, number, figure",
    "prevent" => "stop, keep from happening, forbid, keep, hinder, bar",
    "preventive" => "(ie. preventive services) practices that help keep you well",
    "prevention" => "stop, bar, avoid, not permitted, not allowed, to avoid ill effects",
    ...
    "projectile" => "flying object, fast object, thrown object, object moving with great force and speed, as in “projectile vomit”",
    "proliferate" => "grow, spread, reproduce",
    "prophylactic" => "drugs given to prevent sickness or pregnancy, birth control, condom",
    "prophylaxis" => "prevention, remedy, curative, protection",
    "prophylaxis (dental, oral)" => "basic teeth cleaning",
    "prostate" => "gland in male body that makes sperm",
    "prostatitis" => "infection of the prostate",
    "prosthodontics" => "treatment using crowns, bridges, partials and/or dentures",
    "protocol" => "method, standard, step-by-step process, way of doing things, rules, code",
    ...
    "PSA test" => "a test to check the health of the prostate",
    "PTSD" => "an anxiety problem after seeing or having a traumatic event; problem with fear after seeing or having a fearful event; flashbacks of negative experience",
    ...
    "pulpotomy" => "take out nerve from a tooth",
    "purchase" => "buy",
    "purulent" => "pus",
    "pyrexia" => "fever",
    ...
    "rapid diagnostic test" => "fast result test to see if someone is sick",
    ...
    "recrudescence" => "when someone who seemed better gets sick again, relapse",
    ...
    "relief" => "feel better, ease, not as bad, ease or lessening from pain or discomfort, less painful, more comfortable",
    ...
    "rigorous" => "hard",
    "risk reduction" => "reducing the chance of something (usually negative) happening, lowering chances, makiing less likely",
    "risk" => "chance",
    ...
    "seroconversion" => "when your body starts to make cells to fight a disease; way your body fights against disease; becoming immune; reacting against disease; fighting disease",
    ...
    "skull" => "bones of head that protect the brain; head bone; bones that protect the brain",
    ...
    "stress" => "physical, mental or emotional tension or strain; pressure; worry",
    ...
    "trigger" => "cause, starts, something that can bring on symptoms of a disease, lead to",
    "trimester" => "three months; three month's time",
    "tuberculosis" => "TB, a disease of the lungs that can make you cough mucus",
    "tumor" => "growth, lump",
    ...
    "urinate" => "pee",
    "urticarial" => "hives, itch, rash on your skin",
    "uterus" => "womb",
    "utilize" => "use, make use of",
    "UVA" => "UV light, sunlight",
    "UVB" => "UV light, sunlight",
    "vaccinate" => "to protect against disease, usually by a shot",
    "Vaccine Adverse Event Reporting System (VAERS)" => "VAERS, a way for doctors to make sure that vaccines aren’t hurting anyone",
    ...
    "vomit" => "throw up",
    "waning immunity" => "loss of resistance against a disease",
  ...
  foreach ($dictionary as $term => $def) {
